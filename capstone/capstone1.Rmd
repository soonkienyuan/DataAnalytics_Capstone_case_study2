...
The ``weightLogInfo merged`` will not be combined because there are only 8 users in this dataset, while the total number of users in all other datasets is 33.
```{r}
