...
```{r}
dailyActivity_merged <- read.csv("C:\\Users\\soonk\\Documents\\GitHub\\DataAnalytics_Capstone_case_study2\\datasets\\dailyActivity_merged.csv")

dailyCalories_merged  <- read.csv("C:\\Users\\soonk\\Documents\\GitHub\\DataAnalytics_Capstone_case_study2\\datasets\\dailyCalories_merged.csv")

dailyIntensities_merged <- read.csv("C:\\Users\\soonk\\Documents\\GitHub\\DataAnalytics_Capstone_case_study2\\datasets\\dailyIntensities_merged.csv")

dailySteps_merged <- read.csv("C:\\Users\\soonk\\Documents\\GitHub\\DataAnalytics_Capstone_case_study2\\datasets\\dailySteps_merged.csv")

sleepDay_merged <- read.csv("C:\\Users\\soonk\\Documents\\GitHub\\DataAnalytics_Capstone_case_study2\\datasets\\sleepDay_merged.csv")

weightLogInfo_merged <- read.csv("C:\\Users\\soonk\\Documents\\GitHub\\DataAnalytics_Capstone_case_study2\\datasets\\weightLogInfo_merged.csv")
```
...
as.data.frame(table(dailyActivity_merged$Id))
...
```{r}
#Steps, Distance, Intensities, Calories
head(dailyActivity_merged)
```

Hence, I will join merge the `dailyActivity_merged` with `sleepDay_merged` and `weightLogInfo_merged`.

```{r}
#Store the all datasets using list data type 

df_list <- list(dailyCalories_merged, dailyIntensities_merged, dailySteps_merged)

df_dailyActivity<- df_list %>% reduce(full_join, by='Id') %>% select(-ActivityDay.y) %>% rename(Date=ActivityDay.x)



merge(sleepDay_merged, df_dailyActivity, by = "Id",all = TRUE)
...
df_dailyActivity %>% select(-ActivityDay) %>% rename(Date = ActivityDate)

```

Store the all datasets using `list` data type and then

## 3.0 PHASE 3 : PROCESS

df_list\<- list(dailyActivity_merged, dailyCalories_merged, dailyIntensities_merged, dailySteps_merged, sleepDay_merged, weightLogInfo_merged)
